...
public struct ActionsResponse: Codable, Hashable, Sendable {
    ...
    public let actions: [ActionResponse]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.actions = try container.decode([ActionResponse].self, forKey: .actions)
