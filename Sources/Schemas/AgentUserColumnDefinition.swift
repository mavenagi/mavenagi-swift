...
public struct AgentUserColumnDefinition: Codable, Hashable, Sendable {
    ...
    public let metric: AgentUserMetric
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.metric = try container.decode(AgentUserMetric.self, forKey: .metric)
