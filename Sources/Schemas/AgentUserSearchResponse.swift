...
public struct AgentUserSearchResponse: Codable, Hashable, Sendable {
    ...
    public let agentUsers: [AgentUser]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.agentUsers = try container.decode([AgentUser].self, forKey: .agentUsers)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.agentUsers, forKey: .agentUsers)
    }
