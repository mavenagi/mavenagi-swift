...
public struct AgentsSearchRequest: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sort = try container.decodeIfPresent(AgentField.self, forKey: .sort)
        self.filter = try container.decodeIfPresent(AgentFilter.self, forKey: .filter)
