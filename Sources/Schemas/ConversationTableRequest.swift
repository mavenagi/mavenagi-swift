...
public struct ConversationTableRequest: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        fieldGroupings: [ConversationGroupBy],
        columnDefinitions: [ConversationColumnDefinition],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.fieldGroupings = try container.decode([ConversationGroupBy].self, forKey: .fieldGroupings)
        self.columnDefinitions = try container.decode([ConversationColumnDefinition].self, forKey: .columnDefinitions)
