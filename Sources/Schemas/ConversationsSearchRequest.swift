...
public struct ConversationsSearchRequest: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sort = try container.decodeIfPresent(ConversationField.self, forKey: .sort)
        self.filter = try container.decodeIfPresent(ConversationFilter.self, forKey: .filter)
