...
public struct CustomersSearchRequest: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        size: Int? = nil,
        sortDesc: Bool? = nil,
        sort: CustomerField? = nil,
        filter: CustomerFilter? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sort = try container.decodeIfPresent(CustomerField.self, forKey: .sort)
        self.filter = try container.decodeIfPresent(CustomerFilter.self, forKey: .filter)
