...
public struct CustomersSearchResponse: Codable, Hashable, Sendable {
    ...
    public let customers: [CustomerResponse]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.customers = try container.decode([CustomerResponse].self, forKey: .customers)
