...
public struct EventRow: Codable, Hashable, Sendable {
    ...
    /// order.
    public let identifier: [EventField: FieldValue]
    /// One entry per grouping, in the order the groupings were requested.
    public let identifiers: [EventRowIdentifier]
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        data: [String: CellData],
        identifier: [EventField: FieldValue],
        identifiers: [EventRowIdentifier],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.identifier = try container.decode([EventField: FieldValue].self, forKey: .identifier)
        self.identifiers = try container.decode([EventRowIdentifier].self, forKey: .identifiers)
