...
public struct EventTriggersSearchRequest: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sort = try container.decodeIfPresent(TriggerField.self, forKey: .sort)
