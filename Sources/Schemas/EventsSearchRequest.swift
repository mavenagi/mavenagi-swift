...
public struct EventsSearchRequest: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.sort = try container.decodeIfPresent(EventField.self, forKey: .sort)
        self.filter = try container.decodeIfPresent(EventFilter.self, forKey: .filter)
