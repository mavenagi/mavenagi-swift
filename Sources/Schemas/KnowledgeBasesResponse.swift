...
public struct KnowledgeBasesResponse: Codable, Hashable, Sendable {
    ...
    public let knowledgeBases: [KnowledgeBaseResponse]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.knowledgeBases = try container.decode([KnowledgeBaseResponse].self, forKey: .knowledgeBases)
