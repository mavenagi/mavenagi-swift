...
public struct ListAgentCapabilitiesResponse: Codable, Hashable, Sendable {
    ...
    public let data: [AgentCapability]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decode([AgentCapability].self, forKey: .data)
